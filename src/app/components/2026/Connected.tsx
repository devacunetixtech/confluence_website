...
const Connected = () => {
  return (
    <section id='contact' className='pt-8 pb-8 px-6 md:px-20 max-w-7xl mx-auto relative z-10'>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        {/* Right Column */}
        <div className="lg:col-span-6 space-y-6" data-aos="fade-left" data-aos-delay="200">
